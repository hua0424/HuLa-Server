...
SELECT 'agent_prompt', '回复契约模板', 'agent.prompt.reply_contract',
...
INSERT INTO base_config (type, config_name, config_key, config_value, tenant_id)
SELECT 'agent_prompt', '身份锚模板', 'agent.prompt.identity_anchor',
...
INSERT INTO base_config (type, config_name, config_key, config_value, tenant_id)
SELECT 'agent_prompt', '人设区块包装模板', 'agent.prompt.persona_section',
